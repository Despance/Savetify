...
class PortfolioModel {
  ...
  // TODO: portfolio id needed

  List<InvestmentModel> investments = [
    InvestmentModel(
        name: "StockA",
        price: 42.69,
        dateOfPurchase: DateTime(2020, 2, 1),
        quantity: 5.2),
    InvestmentModel(
        name: "StockB",
        price: 36.99,
        dateOfPurchase: DateTime(2021, 3, 5),
        quantity: 6.4),
    InvestmentModel(
        name: "CryptoC",
        price: 15.15,
        dateOfPurchase: DateTime(2022, 5, 8),
        quantity: 15.15),
  ];
  PortfolioModel({required String portfolioName})
